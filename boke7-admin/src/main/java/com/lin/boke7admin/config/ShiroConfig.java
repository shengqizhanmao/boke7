package com.lin.boke7admin.config;

import com.lin.boke7admin.shiro.Jwt.JwtFilter;
import com.lin.boke7admin.shiro.core.Realm.UserRealm;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"com.lin.boke7admin"})
@Log4j2
