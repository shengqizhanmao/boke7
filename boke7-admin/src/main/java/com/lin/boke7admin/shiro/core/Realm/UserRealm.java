package com.lin.boke7admin.shiro.core.Realm;
...
//        log.info("------开始授权-------");
        ...
        String infoCache = redisTemplate.opsForValue().get("Info::Token::" + user.getId());
...
//            log.info("------授权结束-------");
        ...
        redisTemplate.opsForValue().set("Info::Token::"+user.getId(), JSON.toJSONString(info), Duration.ofMillis(1000*60*60*24*10));
//        log.info("------存了缓存-------");
//        log.info("------授权结束-------");
        return info;
    }
